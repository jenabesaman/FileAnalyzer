...
def get_sentences(file_name):
    ...
    reader = open(file_name,encoding='latin-1')
...
# x=get_sentences(file_name="C:/Workarea/Summarize/test/ww2.txt")
# # print(f"sentence is: \n {x}")
# print(len(get_sentences(file_name="C:/Workarea/Summarize/test/ww2.txt")))
