...
def summarize(filename, num_of_sentences=8):
    ...
    summary = summary[:-1]
    return summary
    # print(len(all_sentences),summary)
    # len(summary)


# x = summarize(filename="C:/Workarea/File_Analyser/main/Summarize/test/ww2.txt",num_of_sentences=2)
# print(x)
